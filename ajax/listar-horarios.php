...
//validar horario
		...
		//VERIFICAR NA TABELA HORARIOS AGD SE TEM O HORARIO NESSA DATA
			...
			<div class="col-md-2 <?php echo $ocultar ?>" style='display: <?php echo $esconder ?>'>

				<div class="form-check">					
					<input class="form-check-input" type="radio" name="hora" value="<?php echo $hora ?>" <?php echo $checado ?> <?php echo $checado2 ?> <?php echo $checado3 ?> <?php echo $horario_marcado ?> style="height:14px; border-radius:10px; border:1px solid #4d4d4d">
