	...
	<div class="row">
		...
		<div class="col-md-5" style="">
			...
			<div  style="float:left; margin-right:20px">
				...
				<input type="date" class="form-control " name="data-inicial"  id="data-inicial-caixa" value="<?php echo $data_inicio_ano ?>" required>
			...
			<div  style="float:left; margin-right:30px">
				...
				<input type="date" class="form-control " name="data-final"  id="data-final-caixa" value="<?php echo $data_final_ano ?>" required>
