...
if ($id_trat != '') {
	...
	$query = $pdo->prepare("INSERT INTO $tabela SET funcionario = '$funcionario', paciente = '$cliente', hora = '$hora', data = '$data_agd', usuario = '$usuario_logado', status = 'Agendado', obs = :obs, data_lanc = curDate(), servico = '$servico', hash = '$hash', pago = '$pago_agd', convenio = '0', retorno = '$retorno', id_tratamento = '$id_trat', valor = '$val_agg', tipo_pagamento = '$tipo_pagamento', data_retirada = '$data_retirada'");

}else{
	$query = $pdo->prepare("INSERT INTO $tabela SET funcionario = '$funcionario', paciente = '$cliente', hora = '$hora', data = '$data_agd', usuario = '$usuario_logado', status = 'Agendado', obs = :obs, data_lanc = curDate(), servico = '$servico', hash = '$hash', pago = '$pago_agd', convenio = '0', retorno = '$retorno', data_retirada = '$data_retirada'");
}
