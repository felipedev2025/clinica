				...
				<div class="modal-body">
					...
					<div class="row">	
							...
							<div class="row">
								...
								<input type="text" class="form-control" id="endereco" name="endereco" placeholder="Seu Endereço" spellcheck="true">							
				...
				<div class="row">
					...
					<div class="col-md-7" style="font-size:14px">
						...
						<div style="margin-bottom: 5px; border-bottom:1px solid #cecece; padding-bottom:3px">		
							...
							<span style="margin-right: 20px"><b>Cartão SUS</b> <span id="cartao_sus_dados"></span></span>
					...
					<div class="col-md-5" style="border-left: 1px solid #242323; font-size:14px" >							
						...
						<b>Demonstrativo Financeiro</b>	

						<div id="contas_div" style="overflow: scroll; max-height:300px; scrollbar-width: thin; padding:2px">
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-md-6">	
								...
								<select class="form-control" name="atedimentos">
									<option value="Não">Nenhum</option>
