...
<td>
	...
	<big><a href="#" onclick="editar('{$id}','{$nome}','{$telefone}','{$cpf}','{$endereco}','{$data_nasc}','{$tipo_sanguineo}','{$nome_responsavel}','{$cpf_responsavel}','{$convenio}','{$sexo}','{$obs}','{$estado_civil}','{$profissao}','{$telefone2}','{$cartao_sus}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
...
<big><a href="#" onclick="mostrar('{$nome}','{$telefone}','{$endereco}','{$data_nascF}','{$tipo_sanguineo}','{$nome_responsavel}', '{$nome_convenio}', '{$sexo}','{$obs}','{$idade}','{$id}','{$profissao}','{$estado_civil}','{$cpf}','{$telefone2}','{$cartao_sus}')" title="Mostrar Dados"><i class="fa fa-info-circle text-primary"></i></a></big>
...
<script type="text/javascript">
	...
	function editar(id, nome, telefone, cpf, endereco, data_nasc, tipo_sanguineo, nome_responsavel, cpf_responsavel, convenio, sexo, obs, estado_civil, profissao, telefone2, cartao_sus){
	...
	function mostrar(paciente, telefone, endereco, data_nasc, tipo_sanguineo, nome_responsavel, nome_convenio, sexo, obs_paciente, idade, id_paciente, profissao, estado_civil, cpf, telefone2, cartao_sus){
		...
		$('#cartao_sus_dados').text(cartao_sus);
...
<script type="text/javascript">
	...
	$.ajax({
        url: 'paginas/pacientes/listar_contas.php',
        method: 'POST',
        data: {id},
        dataType: "html",

        success:function(result){       
            $("#contas_div").html(result);            
