...
if(@count($res2) > 0){
	...
	$data_cad = $res2[0]['data_cad'];
	$hora_cad = $res2[0]['hora_cad'];
	...
	<table id="" style="border-style: solid; font-size: 9px; margin-bottom:10px; width: 100%; table-layout: fixed; margin-top:0px;">
			...
			<thead>
    			...
    			<tr >
					...
					<td style="width:10%; border-right: 1px solid #000;border-bottom: : 1px solid #000;">CADASTRADO: </td>

					<td colspan="3" style="width:13%; border-bottom: : 1px solid #000;">

						<?php echo @mb_strtoupper($data_cadF) ?> / <?php echo $hora_cad ?>
    			...
    			<tr >
					<td style="width:8%; border-right: 1px solid #000;border-bottom: : 1px solid #000;">ENDEREÇO </td>
					<td colspan="7" style="width:30%;  border-bottom: : 1px solid #000;">
...
<span style="color:#096385; font-size: 10px"><i>Dr <?php echo $nome_funcionario ?> / <?php echo $crm_medico ?></i> <span style="color:#360202; font-size: 9px">(<?php echo $dataF ?>)</span></span><br>
...
<?php if($atedimentos != 'Não'){ ?>

<div style="margin-top: 25px; margin-bottom: 10px; border-bottom: 1px solid #000; font-size:12px"><b>EXAMES E CONSULTAS REALIZADAS</b></div>
...
$finalizados = 0;
$total_soma = 0;
$query = $pdo->query("SELECT * from agendamentos where status LIKE 'Finalizado' and paciente = '$id_paciente' order by data desc, hora desc limit $atedimentos");
