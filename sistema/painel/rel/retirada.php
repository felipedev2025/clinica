...
$data_retirada = $res[0]['data_retirada'];
		...
		<table style="width: 100%; border: 0px solid #ccc;">
			...
			<tr>
				...
				<td style="width: 55%; text-align: right; font-size: 9px;padding-right: 10px;">
						...
						<b><big>PROTOCÓLO DE RETIRADA DE EXAMES</big></b><br>						
...
<p style="text-align:center; font-size:13px"><b>PROTOCÓLO DE RETIRADA</b> 
	RETIRAR EM <?php echo $data_retirada ?>
		</p>

	
	<p style="text-align:center; font-size:13px"><b>
		
		 <?php echo $nome_serv ?></b></p>
		...
		<p style="font-size: 12px; background-color: #f0fff0; border: 1px solid #4CAF50; padding: 8px 12px; border-radius: 6px; color: #2e7d32;">
  <b>Observação: </b> O exame só será entregue com apresentação desse protocolo ou com documento pessoal do paciente
</p>
  ...
  Clínica: <?php echo $nome_sistema ?><br>
  Telefone: <?php echo $telefone_sistema ?><br>
  Endereço: <?php echo $endereco_sistema ?>
</p>
