		...
		<table style="width: 100%; border: 0px solid #ccc;">
			<tr>
				...
				<td style="width: 40%; text-align: right; font-size: 9px;padding-right: 10px;">
						<b><big>RELATÓRIO DE SAÍDAS DE MEDICAMENTOS</big></b><br> <?php echo mb_strtoupper($texto_filtro) ?> <br> <?php echo mb_strtoupper($data_hoje) ?>
				</td>
			</tr>		
		</table>
	</div>
		...
		<table id="cabecalhotabela" style="border-bottom-style: solid; font-size: 9px; margin-bottom:10px; width: 100%; table-layout: fixed;">
			<thead>
				...
				<tr id="cabeca" style="margin-left: 0px; background-color:#CCC">
					<td style="width:20%">REMÉDIO</td>
					<td style="width:8%">QUANTIDADE</td>
					<td style="width:20%">MOTIVO</td>
					<td style="width:14%">USUÁRIO</td>
					<td style="width:8%">DATA</td>
					<td style="width:15%">MÉDICO</td>
					<td style="width:15%">PACIENTE</td>
...
for($i=0; $i<$linhas; $i++){
	...
	$query2 = $pdo->query("SELECT * from remedios where id = '$produto'");
	...
	$nome_paciente = @$res2[0]['nome'];
      ...
      <tr>
<td style="width:20%"><?php echo $nome_produto ?></td>
<td style="width:8%"><?php echo $quantidade ?></td>
<td style="width:20%"><?php echo $motivo ?></td>
<td style="width:14%"><?php echo $nome_usuario ?></td>
<td style="width:8%;"><?php echo $dataF ?></td>
<td style="width:15%;"><?php echo $nome_medico ?></td>
<td style="width:15%;"><?php echo $nome_paciente ?></td>
