...
if ($medico == '') {
	...
	$sql_medico = " and funcionario = '$medico' ";
}
...
$query = $pdo->query("SELECT * from agendamentos where data >= '$dataInicial' and data <= '$dataFinal' and pago LIKE '%$pago%' $sql_convenio $sql_servico and status LIKE '%$status%' $sql_medico order by data asc, hora asc");
